...
Use ... when the input is known to be a single string.
For safety, it will error if its input has length greater than one.

...  is built on ... , so you can use its ... argument and stringr's general interface for describing the ... to be matched.
